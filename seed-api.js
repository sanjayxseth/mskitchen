// Seed database via HTTP API endpoint
// This creates an API endpoint that can be called to seed the database
...
app.listen(PORT, () => {
  console.log(`Seed API server running on port ${PORT}`);
  console.log(`POST /api/seed to seed the database`);
});
