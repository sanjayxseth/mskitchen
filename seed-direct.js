...
// Run with: node seed-direct.js "your-connection-string"
...
if (!connectionString) {
  ...
  console.log('Usage: node seed-direct.js "postgresql://..."');
  process.exit(1);
}
...
const seedDatabase = async () => {
  ...
  try {
    ...
    if (count > 0) {
      console.log(`⚠️  Database already contains ${count} recipes.`);
